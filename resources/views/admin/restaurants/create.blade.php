...
<div class="container m-auto py-3">
    ...
    <form action="{{ route('admin.restaurants.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="restaurant_name" id="restaurant_name" class="form-control @error('restaurant_name') is-invalid @enderror" placeholder="add restaurant name" aria-describedby="titleHlper" value="{{ old('restaurant_name') }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" placeholder="add restaurant address" aria-describedby="titleHlper" value="{{ old('address') }}">
        </div>
        @error('address')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <div class="mb-3">
            ...
            <input type="number" name="delivery_price" id="delivery_price" class="form-control @error('delivery_price') is-invalid @enderror" placeholder="add restaurant name" aria-describedby="titleHlper" value="{{ old('delivery_price') }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="partita_iva" id="partita_iva" class="form-control @error('partita_iva') is-invalid @enderror" placeholder="add restaurant vat" aria-describedby="titleHlper" value="{{ old('partita_iva') }}">
        </div>
        @error('partita_iva')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
